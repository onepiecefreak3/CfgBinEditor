...
namespace plugin_common.Archive
{
    internal class XfspReader : IArchiveReader
    {
        ...
        private IList<NamedArchiveEntry> CreateFileEntries(BinaryReaderX br, int dataOffset, XfspEntry[] entries, BinaryReaderX nameReader)
        {
        ...
        private NamedArchiveEntry CreateFileEntry(BinaryReaderX br, int dataOffset, XfspEntry entry, BinaryReaderX nameReader)
        {
