...
{
    internal class YoKaiWatchTextLayouter : TextLayouter<FuriganaLayoutContext, FuriganaLayoutOptions>
    {
        private readonly IGlyphProvider _furiganaProvider;

        public YoKaiWatchTextLayouter(FuriganaLayoutOptions options, IGlyphProvider glyphProvider, IGlyphProvider furiganaProvider) : base(options, glyphProvider)
        {
