...
namespace CfgBinEditor.Forms
{
    public partial class ConfigurationForm
    {
        ...
        private ConfigurationTreeViewForm _treeViewForm;
        ...
        private void InitializeComponent(Configuration config, IFormFactory formFactory, IValueSettingsProvider settingsProvider)
        {
            ...
            _treeViewForm = formFactory.CreateConfigurationTreeViewForm(config, NoGame_);
